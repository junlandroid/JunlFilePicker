...
//        Toolbar toolbar = (Toolbar) view.findViewById(R.id.toolbar);
        toolbarSubmit = (TextView) view.findViewById(R.id.tv_actionBar_commit);
...
//        toolbarTitle.setText(mTitle);
        ...
        toolbarSubmit.setText(String.format(getString(R.string.selected), ((FilePickerBaseActivity) getActivity()).selectedFiles.size(),mMaxCount));
